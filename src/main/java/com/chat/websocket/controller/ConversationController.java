...
public class ConversationController {
   ...
   private final MessageService messageService;
    ...
    public void addGroupMemberToConversation(@RequestBody AddGroupRequest addGroupRequest) {
        // get current time
        ...
        // save GroupMember
        groupMemberService.createGroupMemberByConversationIDAndContactID(groupMember, addGroupRequest.getConversationID(), addGroupRequest.getContactID());
    }
