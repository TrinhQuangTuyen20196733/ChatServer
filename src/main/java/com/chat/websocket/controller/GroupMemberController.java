...
public class GroupMemberController {
   ...
   private final ConversationAndGroupmemberService conversationAndGroupmemberService;
    ...
    public MessageResponse addGroupMemberToConversation(@RequestBody @Valid AddGroupMemberRequest addGroupMemberRequest) {
        ...
        // save GroupMember
        if (conversationAndGroupmemberService.createGroupMemberByConversationIDAndContactID(groupMember, addGroupMemberRequest.getConversationID(), addGroupMemberRequest.getContactID()) != null) {
